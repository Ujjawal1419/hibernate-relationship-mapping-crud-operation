...
public class InsertCountryStateController {
    public static void main(String[]args) {
    	...
    	state1.setCapitalName("Lucknow");
    	
    	State state2=new State();
    	state2.setId(102);
    	state2.setName("Jharkhand");
    	state2.setCapitalName("Ranchi");
    	
    	State state3 = new State();
    	state3.setId(103);
    	state3.setName("Bihar");
    	state3.setCapitalName("patna");
    	...
    	country.setCapitalName("New-Delhi");
    	country.setSattes(states);
